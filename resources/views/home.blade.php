        ...
        <div class="welcome">
            <div class="radio-btn-section">
                <form action="#">
                    ...
                    <p class="lender-rb">
                      <input type="radio" id="rd1" name="radio-group" onclick="handleClick(this);" value="lender">
                      <label for="rd1">Lender</label>
                    </p>
                    <p class="borrower-rb">
                      <input type="radio" id="rd2" name="radio-group" onclick="handleClick(this);" value="borrower">
            ...
            <div class="both-forms">
                <div class="documents-wrap lender-form">
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->two_yrs_it_returns == 0) { ?>
                            <span class="waiting"><img class="cards-icon" src="images/warning.png" alt="warning"> Pending</span>
                            <?php } else { ?>
                            <span class="uploaded"><img class="cards-icon" src="images/select.png" alt="select"> Success</span>
                            <?php } ?>
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->one_yr_business_statement == 0) { ?>
                            <span class="waiting"><img class="cards-icon" src="images/warning.png" alt="warning"> Pending</span>
                            <?php } else { ?>
                            <span class="uploaded"><img class="cards-icon" src="images/select.png" alt="select"> Success</span>
                            <?php } ?>
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->pan_number != '' && $kyc->kyctype == 'lender') { ?>
                ...
                <div class="documents-wrap borrower-form">
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->three_months_payslip == 0) { ?>
                            <span class="waiting"><img class="cards-icon" src="images/warning.png" alt="warning"> Pending</span>
                            <?php } else { ?>
                            <span class="uploaded"><img class="cards-icon" src="images/select.png" alt="select"> Success</span>
                            <?php } ?>
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->six_months_sal_statement == 0) { ?>
                            <span class="waiting"><img class="cards-icon" src="images/warning.png" alt="warning"> Pending</span>
                            <?php } else { ?>
                            <span class="uploaded"><img class="cards-icon" src="images/select.png" alt="select"> Success</span>
                            <?php } ?>
                    ...
                    <div class="cards">
                        <div class="status">
                            <?php if($kyc->pan_number != '' && $kyc->kyctype == 'borrower') { ?>
                            <span class="uploaded"><img class="cards-icon" src="images/select.png" alt="select"> Success</span>
                            <?php } else { ?>
        ...
        <div class="modal-body">
          ...
          <form name="kycForm" id="kycForm" method="post" action="javascript:void(0)">
            <div class="form-group">
                ...
                <input type="text" name="kyctype" id="kyctype" class="form-control">
